...
use crate::{
    ...
    transport_parameters::TransportParameterConfig,
};
...
pub struct TransportConfig {
    ...
    /// Optional ordered transport parameter list for browser impersonation.
    ///
...
impl TransportConfig {
    ...
    /// Set a custom transport parameter list for browser impersonation.
    ///
    ...
    /// to apply a per-connection Fisher-Yates shuffle (matching Chrome's behaviour).
    ...
    pub fn transport_parameter_config(
        &mut self,
        config: TransportParameterConfig,
    ) -> &mut Self {
